...
import com.dora.repository.ProductRepository;
import com.dora.service.ProductService;
import com.dora.service.dto.ProductDTO;
import com.dora.service.mapper.ProductMapper;
...
public class ProductResourceIntTest {
    ...
    private static final Integer DEFAULT_REQUEST_QUANTITY = 1;
    private static final Integer UPDATED_REQUEST_QUANTITY = 2;
    ...
    public static Product createEntity(EntityManager em) {
        Product product = new Product()
            ...
            .requestQuantity(DEFAULT_REQUEST_QUANTITY);
        return product;
    }
    ...
    public void createProduct() throws Exception {
        ...
        assertThat(testProduct.getRequestQuantity()).isEqualTo(DEFAULT_REQUEST_QUANTITY);
    }
    ...
    public void getAllProducts() throws Exception {
        ...
        restProductMockMvc.perform(get("/api/products?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].requestQuantity").value(hasItem(DEFAULT_REQUEST_QUANTITY)));
    }
    ...
    public void getProduct() throws Exception {
        ...
        restProductMockMvc.perform(get("/api/products/{id}", product.getId()))
            ...
            .andExpect(jsonPath("$.requestQuantity").value(DEFAULT_REQUEST_QUANTITY));
    }
    ...
    public void updateProduct() throws Exception {
        ...
        updatedProduct
            ...
            .requestQuantity(UPDATED_REQUEST_QUANTITY);
        ...
        assertThat(testProduct.getRequestQuantity()).isEqualTo(UPDATED_REQUEST_QUANTITY);
    }
